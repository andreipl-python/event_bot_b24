...
from handlers import user_event_payments, admin, main_menu, cabinet, personal_selection, about_us, question
...
async def main():
    ...
    dp.include_routers(
        ...
        about_us.router, question.router, error_handler.router
    )
