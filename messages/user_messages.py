...
class UserMessages:
    ...
    def event_description(description: str) -> str:
        formatted_description = (
            ...
            .replace('Как привлекать больше клиентов', '❔ Как привлекать больше клиентов')
            .replace('Как повысить чек, чтобы', '❔ Как повысить чек, чтобы')
            .replace('Что делать, если они слишком', '❔ Что делать, если они слишком')
            .replace('И это НОРМАЛЬНО', 'И это НОРМАЛЬНО 🫶🏻')
            .replace('а вашу целевую аудиторию', 'а вашу целевую аудиторию👌🏻')
        )
    ...
    @staticmethod
    def custom_send() -> str:
        return ('❔ Как привлекать больше клиентов?\n'
                '❔ Как повысить чек, чтобы не остаться без покупателей?\n'
                '❔ Что делать, если они слишком часто уходят «подумать»?\n\n'
                'Все предприниматели рано или поздно сталкиваются в такими вопросами.\n'
                'И это НОРМАЛЬНО 🫶🏻\n\n'
                'Хотите сделать лучше?\n'
                'Чтобы не сливать деньги на рекламу, привлекая не просто лайки и подписки, а вашу целевую аудиторию👌🏻\n\n'
                'Консультация по продвижению и продажам - это разбор вашей стратегии продаж. Как вы привлекаете клиентов, '
                'построение несложных воронок, которые сможете применять самостоятельно. Обсуждаем целевую аудиторию и '
                'методы, которые будут работать <b>ИМЕННО У ВАС</b>.\n\n'
                '💰 Стоимость: 300 зл\n'
                '⏰ Длительность: 1 час\n\n'
                'Забронировать время и день можно после оплаты в <a href="https://t.me/rudnevavolga">личном чате</a> '
                'или в <a href="https://www.instagram.com/insight.club.pl/">инстаграм</a>\n'
                'Контактный номер: +48690265990')
    ...
    async def settings(user_id: int) -> str:
        ...
        first_part = ('<b>Ваши текущие настройки:</b>\n\n'
                      f'Ваш город - 🟢 <b>{user_city}</b>\n\n'
                      f'<b>Ваша анкета предпочтений:</b>\n\n')
        second_part = (f'<b>1. Вид деятельности:</b> {user_activities_str}\n'
                       f'<b>2. Интересующие темы:</b> {user_topics_str}\n'
                       f'<b>3. Что вы продаете:</b> {user_sales_types_str}\n\n') if is_surveyed else '🔴 Анкета не пройдена\n\n'
        third_part = (f'<b>В этом разделе вы можете:</b>\n\n'
                      f'"🌆 Изменить город"\n'
